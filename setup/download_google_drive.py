...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Download a file from Google Drive using its file ID."
    )
    parser.add_argument(
        "file_id",
        help="The ID of the file to download from Google Drive."
    )
    parser.add_argument(
        "file_name",
        help="The name to save the downloaded file as."
    )
    parser.add_argument(
        "target",
