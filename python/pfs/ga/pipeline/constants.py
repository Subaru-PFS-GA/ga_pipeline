...
class Constants():
    ...
    PFSDESIGN_FILENAME_GLOB = 'pfsDesign-{pfsDesignId}.fits'
    PFSDESIGN_FILENAME_FORMAT = 'pfsDesign-{pfsDesignId:016x}.fits'
    PFSDESIGN_FILENAME_REGEX = r'pfsDesign-0x(?P<pfsDesignId>[0-9a-fA-F]{16})\.(?:fits|fits\.gz)$'

    PFSCONFIG_DIR_FORMAT = 'pfsConfig'
    PFSCONFIG_DIR_GLOB = 'pfsConfig/**/'
    PFSCONFIG_FILENAME_GLOB = 'pfsConfig-{pfsDesignId}-{visit}.fits'
    PFSCONFIG_FILENAME_FORMAT = 'pfsConfig-{pfsDesignId:016x}-{visit:06d}.fits'
    PFSCONFIG_FILENAME_REGEX = r'pfsConfig-0x(?P<pfsDesignId>[0-9a-fA-F]{16})-(?P<visit>\d{6})\.(fits|fits\.gz)$'
    PFSCONFIG_PATH_REGEX = r'pfsConfig/(?P<date>\d{4}-\d{2}-\d{2})/' + PFSCONFIG_FILENAME_REGEX
