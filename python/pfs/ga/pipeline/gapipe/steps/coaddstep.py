...
class CoaddStep(PipelineStep, CoaddStepMixin):
    ...
    def run(self, context):       
        ...
        merged_spectrum = self._merge_spectra(context, coadd_spectra)

        self._append_metadata(context, coadd_spectra, merged_spectrum, mask_flags)
    ...
    def __load_spectra(self, context):
        ...
        no_data_bit, no_continuum_bit, exclude_bits, mask_flags = self._get_mask_flags(context, input_spectra)
